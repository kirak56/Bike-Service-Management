...
public class ServiceBookingController {
    ...
    public ResponseEntity<Page<ServiceBooking>> searchBookingsByCriteria(
        ...
        Page<ServiceBooking> bookings = serviceBookingService.searchBookingsByCriteria(status, technicianPrefix, customerPrefix, pageable);
